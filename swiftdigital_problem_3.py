#(1)სვეტები, რიგები და წამების რაოდენობა.
r,c,n = input().split()
r,c,n = int(r),int(c),int(n)
initial_state = [] #გრიდი ინფუთების შემდეგ
for i in range(r):
    row = list(input())
    initial_state.append(row)
    
#(2)ბომბის აფეთქების ლოგიკა
...
"""
(3)გრიდი ყველა შესაძლო მდგომარეობა და მათი გარემოებები
